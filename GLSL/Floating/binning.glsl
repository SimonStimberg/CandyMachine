...
void main()
{
	// to use the code of David Brown (setting these as constants)
	// but using this values should make them uneffecting in the following calculations (so they might be erased out)
	...
	// ivec3 vox = ivec3(floor( (vec3(.5)+(worldSpacePos-uVoxelOrigin)/uVoxelWorld)*uBinRes));	// not sure what this is doing, but probably it is calculating the voxel position of the particle
